...
/**
 * This class provides a wrapper for network errors when making requests to RIBBIT API v4
 */
export class ValidiFiBankLoginError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "ValidiFiBankLoginError";
